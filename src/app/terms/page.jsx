      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 md:p-8 mb-8">
          <p className="mb-6 text-gray-600 dark:text-gray-400">
            LawHub('로허브', 'https://lawhub.kr')을 이용해 주셔서 감사합니다. 본 약관은 다양한
            LawHub 서비스의 이용과 관련하여 LawHub 서비스를 제공하는 LawHub와 이를 이용하는 LawHub
            서비스 회원(이하 '회원') 또는 비회원과의 관계를 설명하며, 아울러 여러분의 LawHub 서비스
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              이 약관은 LawHub(이하 '회사')가 제공하는 모든 서비스(이하 '서비스')의 이용조건 및
