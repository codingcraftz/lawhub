					...
					{enforcements.map((enf) => (
						...
						>
							...
							{expandedId === enf.id && (
								...
								>
									<EnforcementDeadlines enforcementId={enf.id} isAdmin={isAdmin} handleSuccess={fetchEnforcements} />
									<EnforcementTimelines enforcementId={enf.id} isAdmin={isAdmin} handleSuccess={fetchEnforcements} />
								</motion.div>
							)}
						</li>
					))}
