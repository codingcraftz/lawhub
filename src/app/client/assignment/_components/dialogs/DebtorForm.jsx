				...
				<form onSubmit={handleSubmit}>
					...
					<Box mb="3">
						...
						<InputMask
							...
							onChange={(e) => handleChangeRaw("registration_number", e.target.value)}
						>
							{(inputProps) => (
								<input
									{...inputProps}
					...
					<Box mb="3">
						...
						<input
							...
							onChange={(e) => handleChangeRaw("workplace_name", e.target.value)}
							className="w-full p-2 border border-gray-6 rounded text-gray-12 focus:outline-none focus:border-gray-8"
						/>
					</Box>
					...
					<Box mb="3">
						...
						<input
							...
							onChange={(e) => handleChangeRaw("workplace_address", e.target.value)}
							className="w-full p-2 border border-gray-6 rounded text-gray-12 focus:outline-none focus:border-gray-8"
						/>
					</Box>
