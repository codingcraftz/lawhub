...
import PersonalExcelUploader from './PersonalExcelUploader';
  ...
  return (
    <Box className='flex w-full p-4 max-w-screen-2xl mx-auto sm:px-2 md:px-4 lg:px-24'>
      <Tabs className='w-full' defaultValue='staffManagement'>
        ...
        <TabsContent value='excelUploader' className='animate-fadeIn w-full'>
          <ExcelUploader />
        </TabsContent>
        <TabsContent value='personalExcelUploader' className='animate-fadeIn w-full'>
          <PersonalExcelUploader />
        </TabsContent>
      </Tabs>
    </Box>
  );
